...
class AvatarForm extends StatefulWidget {
  const AvatarForm({required this.ecommerce, super.key});
...
class _AvatarFormState extends State<AvatarForm> {
  ...
  void _updateAvatar(String? action) async {
    setState(() {
      _loading = true;
    });

    final response = await EcommerceService.updateAvatar(
      widget.ecommerce.id,
      _imageFile,
      action,
    );
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  image: _imageFile == null
                      ? widget.ecommerce.avatarThumb == null
                          ? null
                          : DecorationImage(
                              image: NetworkImage(media_host + widget.ecommerce.avatarThumb),
                              fit: BoxFit.cover,
                            )
                      : DecorationImage(
                          image: FileImage(
